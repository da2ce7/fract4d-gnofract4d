...
mv dist/gnofract4d-2.12-1.$ARCH.rpm dist/gnofract4d-python22-2.12-1.$ARCH.rpm 
...
./mkrpm.sh $BUILD_PYTHON $MIN $MAX
mv dist/gnofract4d-2.12-1.$ARCH.rpm dist/gnofract4d-python23-2.12-1.$ARCH.rpm 
...
./mkrpm.sh $BUILD_PYTHON $MIN $MAX
mv dist/gnofract4d-2.12-1.$ARCH.rpm dist/gnofract4d-python24-2.12-1.$ARCH.rpm 
...
pushd dist
mkisofs -J -R -o gf4d.iso *2.12*.gz *2.12*.rpm
popd dist
