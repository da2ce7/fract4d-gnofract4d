...
mv dist/gnofract4d-2.6-1.i386.rpm dist/gnofract4d-python23-2.6-1.i386.rpm 
...
mv dist/gnofract4d-2.6-1.i386.rpm dist/gnofract4d-python24-2.6-1.i386.rpm 
...
mv dist/gnofract4d-2.6-1.i386.rpm dist/gnofract4d-python22-2.6-1.i386.rpm 
