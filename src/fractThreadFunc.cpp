...
fractThreadFunc::antialias(int x, int y)
{
    ...
    // top left
    (*(pf))(pos, f->maxiter,nNoPeriodIters,x,y,1,&ptmp,&p,NULL); 
    pixel_r_val += ptmp.r;
    pixel_g_val += ptmp.g;
    pixel_b_val += ptmp.b;
    pos+=ff->delta_aa_x;
    ...
    // top right
    (*(pf))(pos, f->maxiter,nNoPeriodIters,x,y,2,&ptmp,&p,NULL); 
    pixel_r_val += ptmp.r;
    pixel_g_val += ptmp.g;
    pixel_b_val += ptmp.b;
    ...
    // bottom left
    (*(pf))(pos, f->maxiter,nNoPeriodIters,x,y,3,&ptmp,&p,NULL); 
    pixel_r_val += ptmp.r;
    pixel_g_val += ptmp.g;
    pixel_b_val += ptmp.b;
    pos+= ff->delta_aa_x;
    ...
    // bottom right
    (*(pf))(pos, f->maxiter,nNoPeriodIters,x,y,4,&ptmp,&p,NULL); 
    pixel_r_val += ptmp.r;
    pixel_g_val += ptmp.g;
    pixel_b_val += ptmp.b;
